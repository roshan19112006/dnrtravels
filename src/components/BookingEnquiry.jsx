...
🚗 *Vehicle:* ${formData.vehicle}`;
  ...
  const handleFormSubmit = (e) => {
    ...
    const waUrl = `https://wa.me/${siteConfig.whatsappNumber}?text=${generateWhatsAppMessage()}`;
    ...
    <section id="enquiry" className="section-padding lite-booking-section">
      <div className="container">
        ...
        <div className="section-header" style={{ marginBottom: '20px' }}>
          <div className="section-badge emerald" style={{ marginBottom: '6px' }}>
            <Sparkles size={12} />
            <span>Instant WhatsApp Booking</span>
          </div>
          <h2 className="section-title" style={{ fontSize: '1.8rem', marginBottom: '4px' }}>
            Book Your <span className="gold-highlight">Cab</span>
          </h2>
          <p className="section-subtitle" style={{ fontSize: '0.88rem', marginBottom: '0px' }}>
            Fill the details below to send your booking instantly via WhatsApp
          </p>
        </div>

        {/* Small & Lite Booking Box */}
        <div className="lite-booking-card">
          <form className="lite-form" onSubmit={handleFormSubmit}>
            <div className="lite-form-grid">
              ...
              <div className="lite-input-group">
                ...
                <select
                  ...
                  onChange={handleChange}
                >
                  <option value="Dzire Sedan (4 Seats)">Dzire Sedan (4 Seats)</option>
                  <option value="Ertiga SUV (6-7 Seats)">Ertiga SUV (6-7 Seats)</option>
                  <option value="Innova Crysta (7 Seats)">Innova Crysta (7 Seats)</option>
                  <option value="Tempo Traveller (12-14 Seats)">Tempo (12-14 Seats)</option>
                </select>
              </div>
            </div>

            {/* Single WhatsApp Submit Button */}
            <div className="lite-actions-row" style={{ marginTop: '6px' }}>
              <button
                type="submit"
                className="btn btn-whatsapp lite-wa-submit-btn"
              >
